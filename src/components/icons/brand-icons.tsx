...
// Brand icons (GitHub, X/Twitter) were removed from lucide-react in v1 for
// trademark reasons. These lightweight SVG components preserve the original
// logos and accept the same className/size props used elsewhere in the UI.
