...
export const PERMISSIONS = [
    ...
    "product.archive", "product.import", "product.export",

    "category.view", "category.create", "category.update", "category.delete",

    "inventory.view", "inventory.adjust", "inventory.opname", "inventory.transfer",

    "sale.view", "sale.create", "sale.cancel", "sale.return",
    ...
    "receivable.view", "receivable.payment",
    "payable.view", "payable.payment",

    "accounting.view", "accounting.journal", "accounting.ledger",
