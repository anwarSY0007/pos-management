...
async function main() {
    ...
    for (const b of BRANCHES) {
        const branch = await prisma.branch.upsert({
            where: { code: b.code },
            update: {},
            create: { code: b.code, name: b.name, address: b.address, phone: b.phone },
        });
...
const UNITS = [
    { name: "Pieces", symbol: "pcs" }, { name: "Box", symbol: "box" },
    { name: "Kilogram", symbol: "kg" }, { name: "Liter", symbol: "ltr" },
];
...
for (const u of UNITS) {
    const un = await prisma.unit.upsert({ where: { name: u.name }, update: {}, create: u });
...
const PRODUCTS = [
    { sku: "SKU-0001", name: "Air Mineral 600ml", cat: "Minuman", unit: "Pieces", brand: "Umum", pp: "2500", sp: "4000", min: "24", tax: "11" },
    { sku: "SKU-0002", name: "Kopi Sachet", cat: "Minuman", unit: "Pieces", brand: "Merek A", pp: "1200", sp: "2000", min: "48", tax: "11" },
    { sku: "SKU-0003", name: "Mie Instan Goreng", cat: "Makanan", unit: "Pieces", brand: "Merek A", pp: "2800", sp: "3500", min: "72", tax: "11" },
    { sku: "SKU-0004", name: "Biskuit Cokelat", cat: "Snack", unit: "Box", brand: "Merek B", pp: "8500", sp: "11000", min: "12", tax: "11" },
    { sku: "SKU-0005", name: "Keripik Kentang", cat: "Snack", unit: "Pieces", brand: "Merek B", pp: "7000", sp: "9500", min: "24", tax: "11" },
    { sku: "SKU-0006", name: "Pulpen Gel", cat: "Alat Tulis", unit: "Pieces", brand: "Umum", pp: "2000", sp: "3500", min: "36", tax: "0" },
    { sku: "SKU-0007", name: "Buku Tulis 38 lbr", cat: "Alat Tulis", unit: "Pieces", brand: "Umum", pp: "3500", sp: "5000", min: "24", tax: "0" },
    { sku: "SKU-0008", name: "Teh Kotak 250ml", cat: "Minuman", unit: "Pieces", brand: "Merek A", pp: "3800", sp: "5000", min: "24", tax: "11" },
];
...
for (const p of PRODUCTS) {
    await prisma.product.upsert({
        ...
        create: {
            ...
            categoryId: catId.get(p.cat)!, unitId: unitId.get(p.unit)!, brandId: brandId.get(p.brand)!,
            purchasePrice: p.pp, sellingPrice: p.sp, minimumStock: p.min, taxRate: p.tax,
        },
    });
}
...
const CUSTOMERS = [
    { customerCode: "CUS-0001", name: "Toko Berkah", phone: "0812-1111-2222", creditLimit: "5000000" },
    { customerCode: "CUS-0002", name: "Warung Bu Sari", phone: "0813-3333-4444", creditLimit: "1000000" },
    { customerCode: "CUS-0003", name: "Kantin Sekolah", phone: "0815-5555-6666", creditLimit: "0" },
];
for (const c of CUSTOMERS) {
    await prisma.customer.upsert({ where: { customerCode: c.customerCode }, update: {}, create: c });
}
const SUPPLIERS = [
    { supplierCode: "SUP-0001", name: "PT Distribusi Sejahtera", phone: "021-7777-8888" },
    { supplierCode: "SUP-0002", name: "CV Sumber Pangan", phone: "021-9999-0000" },
];
